# Git Alias Pack, for Fish

A collection of git aliases that I grew used to, from the Oh-My-ZSH [git plugin](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/git).

The original git plugin provides many [aliases](#aliases) and a few useful [functions](#functions). Not all of them are re-implemented here.
